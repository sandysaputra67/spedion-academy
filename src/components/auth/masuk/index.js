											...
											<form className="form-horizontal m-t-20" action="">
												...
												<div className="form-group m-t-10 mb-0 row">
													<div className="col-sm-7 m-t-20">
														<Link to="pages-recoverpw.html" className="text-muted">
															<i className="mdi mdi-lock"></i> Forgot your password?</Link>
													</div>
													<div className="col-sm-5 m-t-20">
														<Link to="pages-register.html" className="text-muted"><i className="mdi mdi-account-circle"></i> Create an account</Link>
													</div>
												</div>
											</form>
										</div>
